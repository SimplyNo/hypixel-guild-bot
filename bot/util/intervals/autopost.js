...
module.exports = {
    ...
    async interval(bot) {
        ...
        // weekly
        if (currentDate.getDay() == 0 && currentDate.getHours() == 23 && currentDate.getMinutes() >= 59) types.push("weekly");
        // daily
        if (currentDate.getHours() == 23 && currentDate.getMinutes() >= 59) types.push("daily");
        ...
        servers && servers.forEach(serverConf => {
